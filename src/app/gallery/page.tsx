...
import { categories } from '@/constants/galleryData';

export default function GalleryPage() {
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Costume Gallery</h1>
        <p className="text-xl text-gray-600">
          Explore our extensive collection of professionally crafted costumes across various categories
        </p>
      </div>
